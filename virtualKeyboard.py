...
tracker = HandTracker(detectionConfidence=0.8)
...
while True:
    ...
    cv2.putText(frame,str(fps) + " FPS", (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0),2)
    cv2.setMouseCallback('Image', getMousPos)
